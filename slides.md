...
![x% center](assets/architecture.png)
...
![x% center](assets/jit.png)

---

#### Libuv

![x% center](assets/iocompare.png)
...
`package.json` is the `.pom` of npm/node.
...
![x% center](assets/nodemodules.jpg)

---

![x% center](assets/weird.png)
